...
Ext.Loader.addClassPathMappings({
  ...
  "Override.util.PaintMonitor": "app/controller/MainController.js",
  "Override.util.SizeMonitor": "app/controller/MainController.js",
  "TheOpenDoor": "app"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "TheOpenDoor.businessObject.BaseBO": [],
  ...
  "TheOpenDoor.controller.AddEditAddressController": [],
  "TheOpenDoor.controller.AllOrderController": [],
  "TheOpenDoor.controller.BaseController": [],
  "TheOpenDoor.controller.DashboardController": [],
  "TheOpenDoor.controller.FinalOrderPreviewController": [],
  "TheOpenDoor.controller.LoginController": [],
  "TheOpenDoor.controller.MainController": [],
  "TheOpenDoor.controller.OrderController": [],
  "TheOpenDoor.controller.OrderStartController": [],
  "TheOpenDoor.controller.ProfileController": [],
  ...
  "TheOpenDoor.helper.BaseUrl": [
    "BaseUrl"
  ],
  "TheOpenDoor.helper.UrlHelper": [
    "UrlHelper"
  ],
  ...
  "TheOpenDoor.model.AddressGetModel": [],
  "TheOpenDoor.model.CreateUserModel": [],
  "TheOpenDoor.model.DashboardAddressModel": [],
  "TheOpenDoor.model.DashboardModel": [],
  "TheOpenDoor.model.GetAllOrderModel": [],
  "TheOpenDoor.model.GetSlotsModel": [],
  "TheOpenDoor.model.OrderDetailModel": [],
  "TheOpenDoor.model.OrderServiceModel": [],
  "TheOpenDoor.model.StartTimesModel": [],
  "TheOpenDoor.overrides.History": [],
  "TheOpenDoor.profile.Phone": [],
  "TheOpenDoor.profile.Tablet": [],
  "TheOpenDoor.store.AddressGetStore": [],
  "TheOpenDoor.store.CreateUserStore": [],
  "TheOpenDoor.store.DashboardStore": [],
  "TheOpenDoor.store.GetAllOrderStore": [],
  "TheOpenDoor.store.GetSlotsStore": [],
  "TheOpenDoor.store.OrderDetailStore": [],
  "TheOpenDoor.store.OrderServiceStore": [],
  "TheOpenDoor.store.TimeStore": [],
  "TheOpenDoor.view.component.DatePickerField": [],
  "TheOpenDoor.view.component.Header": [],
  "TheOpenDoor.view.component.TimePickerField": [],
  "TheOpenDoor.view.phone.AllOrderView": [],
  "TheOpenDoor.view.phone.BaseNavigationView": [],
  "TheOpenDoor.view.phone.DashboardView": [],
  "TheOpenDoor.view.phone.LoginView": [],
  "TheOpenDoor.view.phone.Main": [],
  "TheOpenDoor.view.phone.OrderDetail": [],
  "TheOpenDoor.view.phone.ProfileView": [],
  "TheOpenDoor.view.phone.SlideNavigator": [],
  "TheOpenDoor.view.phone.order.AddEditAddress": [],
  "TheOpenDoor.view.phone.order.AddressItem": [],
  "TheOpenDoor.view.phone.order.AddressOrderService": [],
  "TheOpenDoor.view.phone.order.AddressView": [],
  "TheOpenDoor.view.phone.order.DateTimeView": [],
  "TheOpenDoor.view.phone.order.FinalOrderPreview": [],
  "TheOpenDoor.view.phone.order.MyNavView": [],
  "TheOpenDoor.view.phone.order.OrderPageView": [],
  "TheOpenDoor.view.tablet.Main": []
});
